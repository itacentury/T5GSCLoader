...
void (*R_AddCmdDrawStretchPic)(float, float, float, float, float, float, float, float,
                               float*, int) = (void (*)(float, float, float, float, float,
                                                        float, float, float, float*,
                                                        int))&R_AddCmdDrawStretchPic_t;
int (*Material_RegisterHandle)(char*,
                               int) = (int (*)(char*, int))&Material_RegisterHandle_t;
void (*R_AddCmdDrawText)(const char*, int, int, float, float, float, float, float, float*,
                         int) = (void (*)(char* text, int maxChars, int font, float x,
                                          float y, float xScale, float yScale,
                                          float rotation, float* color,
                                          int style))&R_AddCmdDrawText_t;
int (*R_RegisterFont)(char*,
                      int) = (int (*)(char* name, int imageTrack))&R_RegisterFont_t;
