...
float ColorVividTeal[4] = {0.0f, 1.0f, 1.0f, 0.0f};
float ColorMutedTeal[4] = {0.0f, 0.7f, 0.7f, 0.0f};
...
void(*R_AddCmdDrawText)(char *, int, int, float, float, float, float, float, float *, int) = 
