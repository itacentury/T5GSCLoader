...
#define cs_hook_install(name, type)                                                      \
    cs_hook_create((popd32)name, (popd32)name##_Hook, (popd32*)&name##_Trampoline, true, \
                   type)
...
typedef enum cs_hook_type { CS_HOOK_TYPE_CTR, CS_HOOK_TYPE_IMPORT } cs_hook_type;
